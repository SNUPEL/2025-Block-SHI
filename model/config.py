...
def create_config():
    ...
    config['data_start_date'] = '2019-05-30'  # 시작일자 (착수일 기준)
    ...
    config['result_data_file_path'] = '../results/20250625_9h_20m_56s/block_allocation_result.xlsx'
    ...
    config['score_position'] = 10  # 동일 정반 배치 시 위치 가중치
